    ...
    <#if section = "form">
          ...
          <div id="loginbox" class="mainbox col-6">
            ...
            <a class="back-login" href="${url.loginUrl}">Đăng nhập</a>
              ...
              <p class="login-text">Đăng ký tài khoản</p>
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            <div style="display: flex; width: 100%">
              <div class="col-6" style="padding-right:8px">
                 <div class="${properties.kcFormGroupClass!}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="lastName" class="${properties.kcLabelClass!}">Họ</label>
                </div>
              ...
              <div class="col-6" style="padding-left:8px">
                <div class="${properties.kcFormGroupClass!}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="firstName" class="${properties.kcLabelClass!}">Tên</label>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
            ...
            <#if !realm.registrationEmailAsUsername>
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="username" class="${properties.kcLabelClass!}">Tên đăng nhập</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="password-confirm"
                               class="${properties.kcLabelClass!}">Nhập lại mật khẩu</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}" style="margin-top:24px">
                    <input class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" type="submit" value="Đăng ký"/>
                </div>
            </div>
        </form>
        </div>
